...
@Component({
  selector: 'app-candidate-details-recruiter',
  templateUrl: './candidate-details-recruiter.component.html',
  styleUrls: ['./candidate-details-recruiter.component.css']
})
export class CandidateDetailsRecruiterComponent implements OnInit {
