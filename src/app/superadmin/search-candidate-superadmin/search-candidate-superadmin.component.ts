...
@Component({
  selector: 'app-search-candidate-superadmin',
  templateUrl: './search-candidate-superadmin.component.html',
  styleUrls: ['./search-candidate-superadmin.component.css']
})
export class SearchCandidateSuperadminComponent implements OnInit {
