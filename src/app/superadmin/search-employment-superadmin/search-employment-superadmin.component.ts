...
@Component({
  selector: 'app-search-employment-superadmin',
  templateUrl: './search-employment-superadmin.component.html',
  styleUrls: ['./search-employment-superadmin.component.css']
})
export class SearchEmploymentSuperadminComponent implements OnInit {
  ...
  ELEMENT_DATA: any= [
    ...
    {CandidateName:"Martin Luther",CompanyName:'Delloite',EmployeeId: 'J53335', From: '14 Nov,2014', To: 'Present', Role: "A Con",Tenure:"3 month",CTC: '5L'},
    {CandidateName:"Gibson Joseph",CompanyName:'KPMG',EmployeeId: 'J53335', From: '2 Jun,2014', To: 'Present', Role: "A Con",Tenure:"3 month",CTC: '6L'},
    {CandidateName:"Alencier Lopez",CompanyName:'PWC',EmployeeId: 'J53335', From: '7 May,2015', To: '7 May,2018', Role: "A Con",Tenure:"3 month",CTC: '4L'},
    {CandidateName:"Alencier Lopez",CompanyName:'EY',EmployeeId: 'J53335', From: '1 Jun,2018', To: 'Present', Role: "A Con",Tenure:"3 month",CTC: '10L'}
  ];
  //dataSource:String[] =[];
  ...
  ngOnInit() {
    this.filter=[{CompanyName:"",CandidateName:"",EmployeeId:""}];
