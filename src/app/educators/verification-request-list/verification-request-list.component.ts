...
@Component({
  selector: 'app-verification-request-list',
  templateUrl: './verification-request-list.component.html',
  styleUrls: ['./verification-request-list.component.css']
})
export class VerificationRequestListComponent implements OnInit {
